...
static void test_queue_create_clear_destroy(void);
...
queue_suite (void)
{
    ...
    if (NULL
        == (CU_add_test(suite,
                        "test_queue_create_clear_destroy",
                        test_queue_create_clear_destroy)))
    {
        ERROR_LOG("Failed to add test_queue_create_clear_destroy to suite\n");
        suite = NULL;
        goto CLEANUP;
    }
...
static void
test_queue_create_clear_destroy (void)
{
    queue_t *p_queue
